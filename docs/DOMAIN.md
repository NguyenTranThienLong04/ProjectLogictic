...
- Tọa độ pickup được lưu trong immutable pickup snapshot khi tạo Shipment. Shipment cũ/pickup address thiếu tọa độ hoặc destination Warehouse thiếu tọa độ trả lỗi nghiệp vụ `ASSIGNMENT_TARGET_LOCATION_REQUIRED`; không đoán tọa độ.
